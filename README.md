...
## [Predicting the properties of molecules using machine learning](https://github.com/Riddars/data-science/tree/main)
Описание: **Прогнозирование свойств молекул с помощью машинного обучения** является проектом data scince, направленным на изучение набора данных "QM9", извлечение молекулярных дескрипторов и разработку регрессионных моделей для предсказания целевой переменной "Gap".  
